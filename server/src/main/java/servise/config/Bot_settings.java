...
public class Bot_settings {
    ...
    public static  ArrayList<Bot_setting> getList() {
        ...
        list.add(new Bot_setting("Exmo", ExmoExchange.class, "K-bb98c6cec34b24dc2bdd7250b2541d2a4fbbee6e", "S-d4411e7f4ba1af42900f5f05f0091ee5dbb16321") );
        list.add(new Bot_setting("Binance" ,BinanceExchange.class, "594fb900-05d1-4029-8b0d-bd87bff333db", "8cZRt3XFMGJpyTME") );
        return list;
    }
